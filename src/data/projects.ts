...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A React-based word guessing game called Assembly: Endgame, built with HTML and CSS. Players use programming languages as lives to guess the correct word and prevent Assembly from taking over the world. The project emphasizes interactive gameplay, responsive design, and a fun, engaging user experience.",
  ...
  },
  {
    ...
    description:
      "A reusable UI Kit developed at Increazy, built with HTML, CSS, Vanilla JavaScript, and Twig. The project focuses on consistency, scalability, and component reuse, providing a solid foundation for building interfaces across multiple projects.",
  ...
  },
  {
    ...
    title: "React Chef AI",
    description:
      "A web application developed with React, HTML, and CSS, allowing users to enter ingredients and receive AI-generated recipes. The project emphasizes interactivity, responsive design, and a smooth, user-friendly experience.",
